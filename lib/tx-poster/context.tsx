...
import { calculateGasMargin } from "@utils/functions/bn";
import Divider from "@components/Divider";

const initValue = {
  // prettier-ignore
  invoke: async ({instance, methodName, overrides,  args, retry, onTransactionResult, onRetryCancel, onError}: {
    instance: any, methodName: any, overrides?: any,  args?: any, retry?: any, onTransactionResult: any, onRetryCancel: any, onError: any
  }) => {}, // eslint-disable-line
};
...
export const TxPosterProvider = ({ children }: { children: ReactChild }) => {
